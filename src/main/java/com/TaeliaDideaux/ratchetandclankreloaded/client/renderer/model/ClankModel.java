package com.TaeliaDideaux.ratchetandclankreloaded.client.renderer.model;
...
public class ClankModel<Type extends Clank> extends AnimatedGeoModel<Type> {
	...
	public ResourceLocation getAnimationFileLocation(Type animatable) {
		return new ResourceLocation(RatchetAndClankReloadedMod.MODID, "animations/clank.animation.json");
	}

	@Override
	public ResourceLocation getModelLocation(Type object) {
		return new ResourceLocation(RatchetAndClankReloadedMod.MODID, "geo/clank_model.geo.json");
	}

	@Override
	public ResourceLocation getTextureLocation(Type object) {
		return new ResourceLocation(RatchetAndClankReloadedMod.MODID, "textures/entities/clank.png");
	}
}